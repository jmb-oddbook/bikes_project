...
**Part 2** which was not part of the official CAB project will utilise the full data set of trips available from Capital Bike Share and focus on working with a large time series set, e.g. rolling averages, compensating for seasonality, &c.
...
The Capital Bikeshare System Data website also offers supplementary material such as member surveys and summaries and *sub* Real Time Data more json information about the configuration and status of the individual stations.
